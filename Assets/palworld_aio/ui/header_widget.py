...
class HeaderWidget (QWidget ):
    ...
    def _setup_ui (self ):
        ...
        layout .addSpacing (8 )
        self .menu_chip_btn =QPushButton (f"{nf .icons ['nf-md-menu']} Menu")
        ...
        self .menu_chip_btn .setFont (QFont ("Consolas",11 ))
        ...
        self .warn_btn .setToolTip ("Warnings")
        try :
        ...
        dropdown_btn .setFont (QFont ("Consolas",14 ))
        menu =QMenu ()
        action_toggle =menu .addAction (nf .icons ['nf-md-theme_light_dark']+" "+(t ("Toggle Theme")if t else "Toggle Theme"))
        menu .addSeparator ()
        action_settings =menu .addAction (nf .icons ['nf-md-cog']+" "+(t ("Settings")if t else "Settings"))
        action_about =menu .addAction (nf .icons ['nf-md-information']+" "+(t ("About PST")if t else "About PST"))
        ...
        minimize_btn .setFont (QFont ("Consolas",14 ))
    ...
    def _open_github (self ,event ):
        ...
        if self ._update_available :
            ...
            webbrowser .open ("https://github.com/deafdudecomputers/PalworldSaveTools")
    ...
    def update_version_text (self ,local_version ,latest_version =None ):
        ...
        if latest_version and self ._update_available :
            self .app_version_label .setText (f"{nf .icons ['nf-cod-github']} {local_version } → {latest_version }")
        else :
